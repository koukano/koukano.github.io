...
直交多項式の零点は、数値積分の標本点として特別な性質を持つ。卒業論文第7章から第8章では、ラグランジュ補間と直交性を用いてガウスの求積公式を導き、重みとして現れるクリストッフェル数が正であることを示している。
...
卒論ではエルミート補間を利用して、一般の十分滑らかな関数について剰余項も導いている。ある $\xi\in(a,b)$ に対して、
